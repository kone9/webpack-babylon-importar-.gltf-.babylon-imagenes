...
module.exports =
{
    ...
    module://aqui en las reglas especifico a webpack lo que va a hacer
    {
        ...
        [
            ...
            { // AUN NO FUNCIONA esto es para procesar archivos babylon,gltf y imagenes
                //test:/\.(jpg|manifest|csv|babylon|log|glb|gltf|env)$/i,
                test:/\.(png|jpg|env|glb|gltf)$/i,
                use:
                [
                    {
                        loader:'file-loader',//el loader para cargar el archivo
                        options:
                        {
                            name:'[name].[ext]',//conserva el mismo nombre y la misma extensión
                            outputPath:'assets/',//Aqui es donde realmente se colocan los nuevos archivos
                            publicPath:'assets/'//esta es la URL que usa el path para buscar el archivo en el javascript principal
                        }
