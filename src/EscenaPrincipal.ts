...
import {VueltaAlMundo} from './VueltaAlMundo';
...
export class EscenaPrincipal 
{
    ...
    constructor(engine:BABYLON.Engine,canvas:HTMLCanvasElement)
    {
        ...
        let _VueltaAlMundo:VueltaAlMundo = new VueltaAlMundo(this.scene);
        console.log("el nombre de la malla es :-> " + _VueltaAlMundo.mesh);
